...
def insert_data_into_table(table_name, generate_values_func, num_records):
    ...
    for _ in range(num_records):
        values = generate_values_func(fake)
...
insert_data_into_table("Game", generate_game_values, 10)
